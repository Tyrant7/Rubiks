...
# Run identity
export RL_RUN_NAME="${RL_RUN_NAME:-transformer_cls-$(date +%Y%m%d-%H%M%S)}"

# Episode structure
export RL_EPISODES="${RL_EPISODES:-20000}"
export RL_NUM_ENVS="${RL_NUM_ENVS:-32}"
...
export RL_TARGET_NETWORK_FREQUENCY="${RL_TARGET_NETWORK_FREQUENCY:-4000}"
